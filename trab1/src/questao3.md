...
Para a segunda análise, empregamos dois tipos de gráficos: o gráfico de barras compactadas horizontais e o gráfico de pizza, novamente. Optamos pelo gráfico de barras compactadas horizontais para comparar as posições de cada música nos charts de cada plataforma de forma clara e direta, permitindo visualizar as diferenças entre os charts das plataformas.O gráfico de pizza foi novamente utilizado, desta vez para mostrar a participação de cada plataforma em relação aos valores nulos presentes no conjunto de dados sobre a posição nos charts das plataformas.Para os marcadores visuais, para o grafico de barras temos 4 barras juntas umas das outras onde mostra a posicao da musica no top 15 gerado e no eixo y em qual posicao do chart a musica esta
